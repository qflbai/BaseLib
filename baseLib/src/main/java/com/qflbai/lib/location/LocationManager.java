...
import com.qflbai.lib.utils.LocationInfoUtil;
            ...
            if (null != location && location.getLocType() != BDLocation.TypeServerError) {
               ...
               // Log.w(TAG,sb.toString());
                ...
                if (location.getAddress()!=null&&(!location.getAddress().address.isEmpty())){
                    LocationInfoUtil.savaLAddress(BaseApplication.getAPPContext(), location.getLatitude() + "", location.getLongitude() + "", location.getRadius() + "", location.getCountryCode(),
