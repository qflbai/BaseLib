package com.qflbai.lib.ui.widget.image;
...
public class ImageBox extends RecyclerView {
    ...
    public ImageBox(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ImageBox(Context context, @Nullable AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ImageBox);
        mLeftMargin = a.getDimensionPixelSize(R.styleable.ImageBox_zib_left_margin, 0);
        mRightMargin = a.getDimensionPixelSize(R.styleable.ImageBox_zib_right_margin, 0);
        mMaxLine = a.getInteger(R.styleable.ImageBox_zib_max_line, DEFAULT_MAX_LINE);
        mImageSize = a.getInteger(R.styleable.ImageBox_zib_img_size_one_line, DEFAULT_IMAGE_SIZE);
        mPadding = a.getDimensionPixelSize(R.styleable.ImageBox_zib_img_padding, DEFAULT_IMAGE_PADDING);
        mDefaultPicId = a.getResourceId(R.styleable.ImageBox_zib_img_default, -1);
        mDeletePicId = a.getResourceId(R.styleable.ImageBox_zib_img_delete, -1);
        mAddPicId = a.getResourceId(R.styleable.ImageBox_zib_img_add, -1);
        mDeletable = a.getBoolean(R.styleable.ImageBox_zib_img_deletable, DEFAULT_DELETABLE);
        a.recycle();
    ...
    public static class MyAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = mInflater.inflate(R.layout.image_box_item, parent, false);
